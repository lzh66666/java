	...
	protected void addListener() {
		saveButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(aString == null || bString == null || cString == null || dString == null || answerString == null) {
					JOptionPane.showMessageDialog(AdminAddSelectQuestionFrame.this, "有的选项没有填写");
					return;
				}
		...
		imageButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				UIManager.put("FileChooser.openButtonText", "上传");

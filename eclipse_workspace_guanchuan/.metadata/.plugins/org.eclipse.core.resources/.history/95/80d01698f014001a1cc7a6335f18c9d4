...
import nuc.ss.shopping.service.BookServiceImpl;
...
public class AdminAddBookFrame extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == addBtn) {
			 ...
			 if(bid.equals("") || name.equals("") || firstLevel.equals("") ||
				secondLevel.equals("") || author.equals("") || price.equals("")
				|| num.equals("")) {
				 JOptionPane.showMessageDialog(null, "书籍信息不全", "消息",
							JOptionPane.WARNING_MESSAGE);
			 }else {
				Book book = new Book(bid, name, firstLevel, secondLevel, author, price, num);
				String massage = bs.addBook(book);
				JOptionPane.showMessageDialog(null, massage, "消息",
						JOptionPane.WARNING_MESSAGE);	 
			 }
		}else {
			bidText.setText("");
